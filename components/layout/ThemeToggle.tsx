...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      {/* Both icons render and swap through CSS rather than JS state. Choosing one from
          `resolvedTheme` would mismatch during hydration, since the server cannot know the
          visitor's theme. */}
