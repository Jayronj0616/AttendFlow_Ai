...
// Everything under this layout is employee data behind a session. Kept out of search
// results regardless of what robots.txt says, since that is only a request.
